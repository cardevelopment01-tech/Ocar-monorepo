...
// Flat settings screen for an already-approved driver's personal info /
// emergency contact. Not a step in a sequence: no stepper, no "Continue",
// saves in place and stays on the page.
export default function PersonalInfo() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await onboardingApi.savePersonalInfo(payload)
      setSaved(true)
  ...
  return (
    <div className="flex flex-col h-[100dvh] bg-bg text-text-primary">
      <SettingsHeader title="Personal & Emergency Info" subtitle="Address, ID & emergency contact" />
