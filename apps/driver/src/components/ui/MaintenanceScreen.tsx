...
export default function MaintenanceScreen({ message, retryAfterSeconds }: MaintenanceScreenProps) {
  const [countdown, setCountdown] = useState(retryAfterSeconds ?? null)
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <p className="text-white/60 text-sm">
          {message ?? 'Ocar is briefly offline for maintenance.'}
        </p>
        {countdown !== null && (
