  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'card-lg':       '0 2px 8px rgba(79,70,229,0.05), 0 8px 32px rgba(79,70,229,0.08)',
        ...
        'button-hover':  '0 6px 28px rgba(79,70,229,0.50)',
        'button-orange': '0 4px 14px rgba(249,115,22,0.35)',
        topbar:          '0 1px 12px rgba(79,70,229,0.07)',
        nav:             '0 -4px 24px rgba(79,70,229,0.08)',
