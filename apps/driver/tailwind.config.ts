...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        card:            '0 1px 2px rgba(0,0,0,0.05), 0 4px 16px rgba(0,0,0,0.06)',
        'card-lg':       '0 2px 8px rgba(0,0,0,0.08), 0 8px 32px rgba(0,0,0,0.08)',
        blue:            '0 0 24px rgba(37,99,235,0.18)',
        orange:          '0 0 24px rgba(249,115,22,0.22)',
        green:           '0 0 20px rgba(34,197,94,0.18)',
        sheet:           '0 -4px 32px rgba(0,0,0,0.10)',
        button:          '0 4px 14px rgba(37,99,235,0.30)',
        'button-hover':  '0 6px 22px rgba(37,99,235,0.40)',
