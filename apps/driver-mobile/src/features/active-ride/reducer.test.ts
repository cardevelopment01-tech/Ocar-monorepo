...
describe('activeRideReducer: round_trip returning status', () => {
  it('walks in_progress -> returning -> completed', () => {
    let state: ActiveRideReducerState = { confirmedStatus: 'in_progress', pendingOptimisticStatus: null }
